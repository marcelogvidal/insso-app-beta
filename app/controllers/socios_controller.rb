class SociosController < ApplicationController
  ...
  private
    ...
    def socio_params
      params.require(:socio).permit(:sexo, :worker_id, :worker, :fecha, :edad, :civil2, :hijo, :hijo2, :contrato, :ocupacion, :temporga, :temptra, :anoestu, :cargo, :unidad, :region, :estu, :ciudad)
    end
end
