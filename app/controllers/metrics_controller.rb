class MetricsController < ApplicationController
  ...
  private
    ...
    def metric_params
      params.require(:metric).permit(:persona, :fuma, :nofuma, :exfuma, :norpeso, :sobrepeso, :obeso, :oxinor, :oxianor, :meditoma, :medinotoma, :epnor, :epanor, :ronqsi, :ronqno, :ronqnose, :periabnor, :periabalt, :pericernor, :periceralt  )
    end
end
